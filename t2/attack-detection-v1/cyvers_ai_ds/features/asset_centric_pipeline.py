...
class AssetCentricFEPipeline:
    ...
    def __init__(
        ...
        total_balance_usd_col: str = 'total_balance_usd',
        ...
        self.total_balance_usd_col = total_balance_usd_col
    ...
    def execute(self, df: pd.DataFrame):
        ...
        #print('df columns after compute_sender_receiver_info : ' , df.columns)
        ...
        #print('df columns after group_by_tx_hash : ' , df.columns)
    ...
    def execute_(self, df: pd.DataFrame):
        ...
        # 2. Aggregate to transaction level features
        n_transactions = df[self.transaction_id_col].nunique()
        #print('self.tx_agg_list before group_by_tx_hash : ' , self.tx_agg_list )
        df = group_by_tx_hash(
            df,
            tx_id_col=self.transaction_id_col,
            agg_list=self.tx_agg_list,
