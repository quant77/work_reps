...
### this is needed for timer decorator
import functools
import time
...
D_CALC_TYPE = {CalcType.TYPE_SUM: 'sum', CalcType.TYPE_MEAN: 'mean', CalcType.TYPE_STD: 'mean', CalcType.TYPE_VAR: 'var', CalcType.TYPE_MEDIAN: 'median', CalcType.TYPE_COUNT: 'count', CalcType.TYPE_MIN: 'min', CalcType.TYPE_MAX: 'max', CalcType.TYPE_PCTILE: 'quantile'}

def LoadCsvFilesDf( lCsvFileName: List, baseFoldePath = '.' ) -> pd.DataFrame:
...
class GrpBySender:
    ...
    #TODO: Add methods which works on the groups by using `self.vGrpLabel` and `self.dfGrpBySender`
